...
export const supportFlows: SupportFlowDefinition[] = [
  ...
  { id: "emergency", title: "One-Minute Reset", description: "Take one small, eyes-open step toward steadiness.", dashboardLabel: "QUICK RESET", iconKey: "bolt", tint: "lavender", intake: { question: "What support feels most available?", options: ["A quiet reset", "Eyes-open grounding", "A little more space", "One small next step"] }, suggestedPracticeId: "one-object-reset", showOnDashboard: false },
];
